...
<html>
    <head>
        ...
        <!-- Morris chart -->
        <link href="<?php echo base_url()?>/AdminLTE/css/morris/morris.css" rel="stylesheet" type="text/css" />
        <!-- jvectormap -->
                                ...
                                <li class="user-header bg-light-blue">
                                    ...
                                    <?php
                                        ...
                                        if ($sexUser=='NotDefined') {
                                            echo '<img src="'. base_url() . '/AdminLTE/img/user-bg.png" class="img-circle" alt="User Image" />';
                                        } elseif ($sexUser=='Homme') {
                                            echo '<img src="'. base_url() . '/AdminLTE/img/avatar5.png" class="img-circle" alt="User Image" />';
                                        } else {
                                            echo '<img src="'. base_url() . '/AdminLTE/img/avatar2.png" class="img-circle" alt="User Image" />';
                                        }
